...
#
# There is a row of seats. Assume that it contains N seats adjacent to each other. There
# is a group of people who are already seated in that row randomly. i.e. some are sitting
# together & some are scattered.
#
# An occupied seat is marked with a character 'x' and an unoccupied seat is marked with a dot ('.')
#
# Now your target is to make the whole group sit together i.e. next to each other, without
# having any vacant seat between them in such a way that the total number of hops or jumps
